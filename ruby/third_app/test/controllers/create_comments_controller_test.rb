...
class CreateCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create create_comment" do
    assert_difference('CreateComment.count') do
      post create_comments_url, params: { create_comment: { comment: @create_comment.comment, name: @create_comment.name } }
    end
  ...
  test "should update create_comment" do
    patch create_comment_url(@create_comment), params: { create_comment: { comment: @create_comment.comment, name: @create_comment.name } }

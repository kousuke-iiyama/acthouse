...
Plugin URI: http://www.thefreewindows.com/16305/download-auto-limit-posts-free-wordpress-plugin-create-automatic-excerpts
		...
		if ( (is_home() && $alpr_post_home == "on") || (is_category() && $alpr_post_category == "on") || (is_archive() && $alpr_post_archive == "on") || (is_search() && $alpr_post_search == "on") ) {
			...
			if ($ismoretag2[0] != "more") {
				...
				if ($alpr_post_linktext != "" && $alpr_share == "on"){
					echo " <a id='alpr' style='visibility:visible;".$alpr_style.";' href='" .get_permalink(). "'>".$alpr_post_linktext."</a> | <a id='alpr' style='visibility:visible;".$alpr_style.";' target='_blank' href='http://www.socializer.info/share.asp?docurl=" .get_permalink(). "&doctitle=".get_the_title()."'>".$alpr_post_sharetext."</a>" ;
				}
				if ($alpr_post_linktext != "" && $alpr_share != "on"){
...
<style>
    ...
    <h2 style="font-weight:normal;font-size:33px;color:#C45A57;padding-top:0;margin-top:25px;margin-left:35px;letter-spacing:1px;">
    	...
    	<span style="margin-left:24px;margin-bottom:22px;"><a style="color:#2b95ff;text-decoration:none;letter-spacing:2px;font-size:15px;" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=8LEU4AZ8DWET2" target="_blank">You are very welcome to donate for Auto Limit Posts any amount you like</a></span>
    		<br>
    <span style="margin-left:24px;"><a style="color:#2b95ff;text-decoration:none;letter-spacing:2px;font-size:15px;" href="http://www.socializer.info/share.asp?docurl=http://www.thefreewindows.com/16305/download-auto-limit-posts-free-wordpress-plugin-create-automatic-excerpts&doctitle=Auto Limit Posts" target="_blank">Share</a> <i style="font-size:15px;">&</i> <a style="color:#2b95ff;text-decoration:none;letter-spacing:2px;font-size:15px;" target="_blank" href="http://www.socializer.info/follow.asp?docurlf=https://www.facebook.com/TheFreeWindows&docurlt=https://twitter.com/TheFreeWindows&docurlg=https://plus.google.com/107469524242742386932&myname=TheFreeWindows">Follow!</a></span>
    	</h2>
...
<div align="center" style="padding:22px;font-size:17px;letter-spacing:1px;">
	...
	&raquo; Don't miss also the <a style="color:#2b95ff;text-decoration:none;font-size:18px;font-variant:small-caps;" target="_blank" href="http://www.thefreewindows.com/5598/socializer-share-wordpress-posts-pages/">Socializer!</a> & the <a style="color:#2b95ff;text-decoration:none;font-size:18px;font-variant:small-caps;" target="_blank" href="http://www.thefreewindows.com/15816/reveal-posts-visitors-share-social-networks/">Social Share Motivator</a> free WordPress plugins</div>


<div align="center" style="text-align:center;margin-top:70px;"> &nbsp;  &nbsp;  &nbsp; <a style="color:silver;text-decoration:none;font-weight:bold;font-size:20pt;letter-spacing:3px;" href="http://www.thefreewindows.com/" target="_blank">TheFreeWindows</a></div>

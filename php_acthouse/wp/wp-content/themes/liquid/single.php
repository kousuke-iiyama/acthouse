          ...
          <div class="row">
           ...
           <?php while (have_posts()) : the_post(); ?>
            ...
            <ul class="breadcrumb" itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
              <li><a href="<?php echo esc_url( home_url() ); ?>" itemprop="url"><span itemprop="title"><?php esc_html_e( 'TOP', 'liquid' ); ?></span></a></li>
           ...
           <?php endif; ?>         
            ...
            <nav>
              <ul class="pager">
                ...
                if (!empty( $prev_post )) {
                    echo '<li class="pager-prev"><a href="'.esc_url( get_permalink( $prev_post->ID )).'" class="text-left" title="'.htmlspecialchars($prev_post->post_title).'">'.esc_html__( '&lt; Prev', 'liquid' ).'</a></li>';
                }
                if (!empty( $next_post )) {
                    echo '<li class="pager-next"><a href="'.esc_url( get_permalink( $next_post->ID )).'" class="text-right" title="'.htmlspecialchars($next_post->post_title).'">'.esc_html__( 'Next &gt;', 'liquid' ).'</a></li>';
                } ?>
                </ul>
            </nav>
           ...
           <div class="recommend">
           <div class="ttl"><?php esc_html_e( 'Recommend', 'liquid' ); ?></div>
              <div class="row">
               <?php
                  //recommend
                  $original_post = $post;
